...
@Component({
    selector: 'app-tekne-ticket-details-edit',
    templateUrl: './tekne-ticket-details-edit.component.html',
    styleUrls: ['./tekne-ticket-details-edit.component.scss', '../../../scss/customstyle.css'],
    imports: [CommonModule, FormsModule]
})

export class TekneTicketDetailsEditComponent {
  error: any;
  buttonSpin = false;
  bcolor = false;
  ticketId = '';
  ...
  constructor(public dataService: TekneTicketDetailsEditService, private modalService: NgbModal) {
    this.getOptions();
  }
