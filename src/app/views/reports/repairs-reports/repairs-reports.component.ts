...
export class RepairsReportsComponent {
  ...
  constructor() {
    if(this.userRole === '9' || this.userRole === '16' || this.userRole === '17') {
      ...
      this.reports = [{label: 'Repair Report ', value: 'repair'},{label: 'Status Report', value: 'status'}, { label: 'SVR Report', value: 'svr'}, {label:	'Accessory Enquiry Report', value: 'accessory'}];
    }
  }
}
