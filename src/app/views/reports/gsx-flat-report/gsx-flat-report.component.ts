              ...
              for (let i = 0; i < this.ticketId.length; i++) {
                ...
                if (this.gsxFlatdataTemp !== undefined) {
                  ...
                  this.finalDataTemp.push({
                    ...
                    // customer_reported_system_comptia: (this.gsxFlatdataTemp[0].customer_component_code === null ? '' : this.gsxFlatdataTemp[0].customer_component_code + ' - ') + (this.gsxFlatdataTemp[0].customer_issue_code === null ? '' : this.gsxFlatdataTemp[0].customer_issue_code),
                    // customer_reported_system_comptia: this.gsxFlatdataTemp[0].customer_intake_notes,
                    ...
                    smsNotification: this.smsNotice,
                    emailNotification: this.emailNotice,
                    ctcNotification: this.ctcNotice,
                    ...
                    // customerPaymentDate: this.gsxFlatdataTemp[0].customerPaymentDate,
                    ...
                    // details_of_repair_performed: this.repairPerformedTemp,
                    ...
                    // customer_component_code: this.gsxFlatdataTemp[0].customer_component_code,
                    // customer_issue_code: this.gsxFlatdataTemp[0].customer_issue_code,
